    ...
    <div className="admin-dashboard-container">
      ...
      <div className="admin-dash-body">
        ...
        <aside className="admin-sidebar">
          ...
          <button className={`admin-tab-btn ${activeTab === 'translation' ? 'active' : ''}`} onClick={() => setActiveTab('translation')}>
                      ...
                      <tr key={s.key}>
                        <td>
                          <div className="admin-td-thumb">
                            {s.image ? (
                              ...
                              <div className="admin-icon-box"><i className={`fas ${s.icon}`}></i></div>
                            )}
                          </div>
                        </td>
                        ...
                        <td>
                          <div className="td-actions">
                            <button onClick={() => openEditSvcModal(s, 'services')} className="btn-act-edit" title="Edit">
                              <i className="fas fa-pen"></i> Edit
                            </button>
                            <button onClick={() => handleDeleteService(s.key, s.title, 'services')} className="btn-act-delete" title="Delete">
                  ...
                  <tbody>
                    {translationServices.map(s => (
                      <tr key={s.key}>
                        ...
                        <td>
                          <div className="td-actions">
                            <button onClick={() => openEditSvcModal(s, 'translation')} className="btn-act-edit" title="Edit">
                              <i className="fas fa-pen"></i> Edit
                            </button>
                            <button onClick={() => handleDeleteService(s.key, s.title, 'translation')} className="btn-act-delete" title="Delete">
                              <i className="fas fa-trash-alt"></i> Delete
                            </button>
                          </div>
                        </td>
                  ...
                  <tbody>
                    {menuLinks.map(m => (
                      <tr key={m.id}>
                        ...
                        <td>
                          {m.isMega ? (
                            <span className="badge-mega"><i className="fas fa-layer-group"></i> Mega Dropdown ({m.megaType})</span>
                          ) : (
                            <span className="badge-simple">Standard Link</span>
                          )}
                        </td>
                        <td>
                          <button 
                            onClick={() => updateMenuLink(m.id, { visible: !m.visible })} 
                            className={`status-toggle ${m.visible ? 'active' : 'hidden'}`}
                          >
                        ...
                        <td>
                          <div className="td-actions">
                            <button onClick={() => openEditMenuModal(m)} className="btn-act-edit">
                              <i className="fas fa-pen"></i> Edit
                            </button>
                            <button onClick={() => handleDeleteMenu(m.id, m.label)} className="btn-act-delete">
                              <i className="fas fa-trash-alt"></i> Delete
                            </button>
                          </div>
                        </td>
                  ...
                  <tbody>
                    {leads.map(l => (
                      <tr key={l.id}>
                        ...
                        <td>
                          <div>{l.email}</div>
                          <small style={{ color: '#e8651a' }}>{l.phone}</small>
                        </td>
                        <td><span className="badge-svc">{l.service || 'General Quote'}</span></td>
                        <td className="td-desc">{l.message}</td>
                        <td>
                          <button onClick={() => deleteLead(l.id)} className="btn-act-delete">
                            <i className="fas fa-trash-alt"></i> Delete
                          </button>
                        </td>
                      </tr>
                    ...
                    {leads.length === 0 && (
                      <tr>
                        <td colSpan="6" style={{ textAlign: 'center', padding: '30px' }}>No inquiries received yet.</td>
                      </tr>
                    )}
                  </tbody>
                </table>
